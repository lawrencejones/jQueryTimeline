...
(function() {
  var adjustHeights, animateCircleGrowth, animateEndWires, assignMomentTopValues, bindExpandAllToOrigin, buildLabel, center, createAndPlaceMomentDots, createAndPlaceMomentInfo, createAndPlaceMomentStartWire, createDurationLine, createEmptyTimeline, createMomentAtSpine, createMomentsAtSpine, createTimelineContainer, drawInMarkers, drawTimelineOriginCircle, drawTimelineSpine, getContainer, getNextId, getTestData, getUtils, makeCircle, makeMarker, monthNumToName, parseDate, processExpanded, processTitle, produceIntervals, setContainerData, setPriority, sortMoments, updateMomentInfoCSS;
  ...
  processExpanded = function(m, mainTitle, infoDiv, structure, utils, textLine) {
    var content, i, key, _i, _j, _ref, _ref1;
