...
(function() {
  var animateCircleGrowth, animateMarker, buildLabel, center, createEmptyTimeline, createMomentAtTimeline, createMomentDiv, createTimelineContainer, createTimelineWithMoments, drawInMarkers, drawTimelineOriginCircle, drawTimelineSpine, getContainer, getNextId, getTestData, getUtils, insertMomentsIntoTimeline, makeCircle, makeMarker, monthNumToName, parseDate, printCurrentContainerData, produceIntervals, runTests, setContainerData, shootMarkerByDate;
  ...
  createMomentDiv = function(moment, spine, utils) {
    return spine.append((makeCircle(10, 'red')).css({
  ...
  shootMarkerByDate = function(d, container, utils) {
    ...
    return console.log(utils.dateToMarkerLeft(5));
  };
  ...
  runTests = function(container) {
    ...
    return shootMarkerByDate('2013-03-01', container, getUtils(container));
  };
