...
(function() {
  var adjustHeights, animateCircleGrowth, animateEndWires, assignMomentTopValues, bindExpandAllToOrigin, buildLabel, center, createAndPlaceMomentDots, createAndPlaceMomentInfo, createAndPlaceMomentStartWire, createDurationLine, createEmptyTimeline, createMomentAtSpine, createMomentsAtSpine, createTimelineContainer, drawInMarkers, drawTimelineOriginCircle, drawTimelineSpine, getContainer, getNextId, getUtils, makeCircle, makeMarker, monthNumToName, parseDate, processExpanded, processTitle, produceIntervals, setContainerData, setPriority, sortMoments, updateMomentInfoCSS;

  window.createTimelineWithMoments = function(startDate, endDate, interval, jQueryObject, moments, structure) {
    var m, spine, _i, _len;
    if ((startDate != null) && (endDate != null) && (interval != null) && (jQueryObject != null) && (moments != null) && (moments[0] != null) && (structure != null)) {
      ...
      return console.log(moments.length);
    }
  };
  ...
  createMomentAtSpine = function(m, spine, utils) {
  ...
  createAndPlaceMomentDots = function(moment, spine) {
    ...
    spine.append((moment.startDot = makeCircle(7, '#47ACCA')).delay(1400).css({
      left: 0,
      zIndex: 10
    }).animate({
      left: startLeft
    ...
    spine.append((moment.endDot = makeCircle(7, '#E0524E')).delay(1400).css({
      left: 0,
      zIndex: 11
    }).animate({
      left: endLeft
